                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDsnZcMQYZ6M3Fo0Ks9pwhAwPBuXER7mxpvcUoPMoJfpI8WwQM075UJhsMwjeIEc4NlN0"
                                alt="Your Company">
                        </div>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full"
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTszNWzL73DLDm6qGTXCD5BWkw3vkttbujN4TwdZI_uoCqrHx_lH54C5Y9pIqfa9N8UBV8"
                                            alt="">
                                    </button>
                                </div>
                            </div>
